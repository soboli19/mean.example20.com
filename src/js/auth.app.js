        ...
        let form =  `
          <div class="card login-form">
            <form id="loginForm" class="card-body">
              ...
              <div id="formMsg" class="alert alert-danger text-center" style="display: none;">Invalid username or password</div>
        ...
        var form =  `
            <div class="card login-form">
              <form id="registrationForm" class="card-body">
                ...
                <div id="formMsg" class="alert alert-danger text-center" style="display: none;">Your form has errors</div>
                <div class="form-group">
